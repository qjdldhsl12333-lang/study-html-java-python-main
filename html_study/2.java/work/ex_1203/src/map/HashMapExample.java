...
public class HashMapExample {
	...
	// key 와 value 를 한쌍으로 요소로 갖는다.
	// key 와 value 의 제네릭타입을 각각 설정해줘야한다.
	...
	//map 에 저장되는 key 는  중복 될 수없다.
	//value는 중복이 될 수 있다.
	
	map.put(5,'A');
	
	map.put(1,'F');; //같은 이름을가진 key 가 있으면 추가 x
	...
	//map 에 특정 key 가 들어있는지 검증
	//containsKey(key)
	System.out.println(map.containsKey(1));
	
	//map 에 특정 value 가 들어있는지 검증
	//containsValue(value)
