...
import com.korea.product.entity.T_ORDERS_Entity;

@Repository
public interface T_ORDERS_Repository extends JpaRepository<T_ORDERS_Entity, Integer> {
	//JPQL
