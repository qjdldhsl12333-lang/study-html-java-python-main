...
//이름을 부여 하고 싶다면 @Entity("TodoEntity")처럼
//매개변수를 넣을수 있다.
@Entity
@Table(name = "Todo")//이 엔티티가 어떤 테이블과 메핑될지를 지정한다.
//우리가  Todo테이블을 만들지 않았지만 JPA가 엔티티를 보고 테이블을 자동생성해준다.
public class TodoEntity {
	...
	//특징 : 복잡하지만 여러명이 사용해도 겹치지 않음
	private String id; //이 객체의 id @GeneratedValue 걸어놨기에 자동생성
